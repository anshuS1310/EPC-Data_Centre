...
# Lets the port open (and Render's health check pass) immediately on cold start,
# instead of blocking on Chroma's first-time embedding-model download.
...
async def readiness_guard(request, call_next):
    # Let health checks and docs through immediately regardless of seeding state
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://epc-data-centre-frontend.onrender.com",
    ],
